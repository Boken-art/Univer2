...
namespace Shool2 {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int Id, string name, string surename, string birthdate, string password, int studentid) {
...
namespace Shool2.DatabaseDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([name] = @Original_" +
                "name) AND ([surename] = @Original_surename) AND ([birthdate] = @Original_birthda" +
                "te) AND ([password] = @Original_password) AND ([studentid] = @Original_studentid" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [name], [surename], [birthdate], [password], [" +
                "studentid]) VALUES (@Id, @name, @surename, @birthdate, @password, @studentid);\r\n" +
                "SELECT Id, name, surename, birthdate, password, studentid FROM Student WHERE (Id" +
                " = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [name] = @name, [surename] = @surename, [birthdate] = @birthdate, [password] = @password, [studentid] = @studentid WHERE (([Id] = @Original_Id) AND ([name] = @Original_name) AND ([surename] = @Original_surename) AND ([birthdate] = @Original_birthdate) AND ([password] = @Original_password) AND ([studentid] = @Original_studentid));
SELECT Id, name, surename, birthdate, password, studentid FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Shool2.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, surename, birthdate, password, studentid FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_surename, string Original_birthdate, string Original_password, int Original_studentid) {
        ...
        public virtual int Insert(int Id, string name, string surename, string birthdate, string password, int studentid) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((int)(studentid));
        ...
        public virtual int Update(int Id, string name, string surename, string birthdate, string password, int studentid, int Original_Id, string Original_name, string Original_surename, string Original_birthdate, string Original_password, int Original_studentid) {
            ...
            if ((Original_surename == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_surename));
            }
            if ((Original_birthdate == null)) {
                throw new global::System.ArgumentNullException("Original_birthdate");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surename, string birthdate, string password, int studentid, int Original_Id, string Original_name, string Original_surename, string Original_birthdate, string Original_password, int Original_studentid) {
            return this.Update(Original_Id, name, surename, birthdate, password, studentid, Original_Id, Original_name, Original_surename, Original_birthdate, Original_password, Original_studentid);
        }
    }
